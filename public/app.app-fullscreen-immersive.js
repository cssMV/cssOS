 ...
 *  (CSSOS_WAVE_678g 20260607 — 底部 Home 指示线: 苹果不允许真正隐藏, 自动隐藏只会淡灰、
 *   永不消失; Jing 觉得半灰碍手碍脚 → 已改为【常显正常态, 不再隐藏/淡灰】,
 *   见 ios/App/App/MainViewController.swift 去掉 .bottom 手势延迟。此处不再追求隐藏指示线。)
 *
