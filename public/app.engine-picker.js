...
(function () {
  ...
  var MODEL_OPTIONS = {
    ...
    "llm.cerebras":   ["llama3.1-8b", "qwen-3-235b-a22b-instruct-2507", "gpt-oss-120b", "zai-glm-4.7"],
    "llm.gemini":     ["gemini-2.0-flash", "gemini-1.5-pro", "gemini-1.5-flash-8b"],
    "llm.together":   ["meta-llama/Llama-3.3-70B-Instruct-Turbo", "meta-llama/Llama-3.3-70B-Instruct-FP8-Lora", "Qwen/Qwen2.5-72B-Instruct-Turbo"],
    "llm.mistral":    ["mistral-large-latest", "mistral-medium-latest", "mistral-small-latest"],
    "llm.deepseek":   ["deepseek-chat", "deepseek-reasoner"],
    "llm.huggingface":["meta-llama/Llama-3.3-70B-Instruct", "Qwen/Qwen2.5-72B-Instruct", "mistralai/Mistral-Large-Instruct-2411"],
    "llm.openrouter": ["meta-llama/llama-3.3-70b-instruct:free", "deepseek/deepseek-chat", "anthropic/claude-3.5-haiku", "openai/gpt-4o-mini"],
    // Image
