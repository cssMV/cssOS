...
(function () {
  ...
  function injectStyles() {
    ...
    st.textContent = [
      ...
      "#cssos-import-modal .panel{background:var(--panel-strong);border:1px solid var(--border);border-radius:14px;width:min(92vw,640px);max-height:88vh;overflow-y:auto;color:var(--text);padding:20px;}",
      ...
      "#cssos-import-modal input[type=text], #cssos-import-modal textarea, #cssos-import-modal select{width:100%;background:rgba(127,127,127,0.10);border:1px solid var(--border);border-radius:8px;color:var(--text);padding:8px 10px;font:inherit;box-sizing:border-box;}",
      ...
      "#cssos-import-modal button.ghost{padding:8px 14px;border-radius:999px;border:1px solid var(--border);background:transparent;color:var(--text);cursor:pointer;}",
