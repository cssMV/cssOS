...
(function () {
  ...
  function injectStyle() {
    ...
    s.textContent = [
      ...
      ".cssos-lb-rank{flex:0 0 28px;text-align:center;font:600 14px/1 ui-monospace,monospace;color:rgba(218,255,238,0.6);}",
      ...
      ".cssos-lb-name{font:600 13px/1.25 -apple-system,system-ui,sans-serif;color:#daffee;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}",
      ".cssos-lb-sub{font:500 11px/1.2 ui-monospace,monospace;color:rgba(0,245,160,0.78);margin-top:2px;}",
      ".cssos-lb-empty{padding:18px 6px;color:rgba(218,255,238,0.6);text-align:center;font:500 13px/1.4 -apple-system,system-ui,sans-serif;}",
      ".cssos-lb-empty .cta{display:block;margin-top:10px;color:rgba(0,245,160,0.95);font-weight:600;}",
      ".cssos-lb-loading{padding:18px 6px;color:rgba(218,255,238,0.5);text-align:center;font:500 12px/1 ui-monospace,monospace;}",
    ].join("");
