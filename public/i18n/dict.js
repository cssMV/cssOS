(function () {
  ...
  en: {
    ...
    "action.signin_apple": "Sign in with Apple",
    "action.close": "Close",
    "action.passkeyLogin": "Apple Login",
    "action.passkeySettings": "Apple Login Settings",
    ...
    "login.passkey": "Use Apple Login",
    "billing.limitReached": "Daily limit reached",
    "login.statusGuest": "Guest",
    "login.statusSigned": "Signed in",
    "login.logout": "Log out",
    "passkey.title": "Apple Login",
    "passkey.intro": "Continue securely with your Apple account.",
    "passkey.me.title": "Session",
    "passkey.me.btn": "Refresh /api/me",
    "passkey.bind.title": "Connect Apple Login (requires signed-in session)",
    "passkey.bind.device.placeholder": "Device name (optional)",
    "passkey.bind.btn": "Connect Apple Login",
    "passkey.login.title": "Sign in with Apple",
    "passkey.login.btn": "Use Apple Login",
    "passkey.list.title": "Your Apple Login Records",
    "passkey.list.btn": "Refresh list",
    "passkey.delete.placeholder": "credential_id (copy from list)",
    "passkey.delete.btn": "Delete Apple Login Record",
    "passkey.err.unsupported": "Apple Login is not supported in this environment.",
    "passkey.err.options_missing": "Missing options from server",
    "passkey.err.create_failed": "Apple Login setup failed",
    "passkey.err.get_failed": "Apple Login fetch failed",
    "profile.title": "Profile",
    "profile.passkey": "Apple Login",
    "profile.passkeyEnable": "Enable",
    "profile.passkeyLogin": "Use Apple Login",
    "passkey.enabled": "Apple Login is enabled",
    "passkey.not_enabled": "Apple Login is not enabled yet. Enable it first.",
    "passkey.unsupported": "Apple Login is not supported in this browser or device",
    "passkey.register_options_failed": "Failed to load registration options",
    "passkey.register_verify_failed": "Failed to enable Apple Login",
    "passkey.login_options_failed": "Failed to load login options",
    "passkey.login_verify_failed": "Apple Login verification failed",
    "mic.submit_failed": "Submit failed",
    "mic.listening": "Listening… release to submit",
    "mic.hold_to_create": "Long press the mic to start; release to create lyrics.",
    "mic.submitting": "Submitting...",
    "mic.submitted": "Submitted",
    "mic.permission_denied": "Microphone permission denied",
    "mic.network_error": "Network error",
    "mic.http_error": "Request failed",
    "ui.run_id": "Run",
    ...
    "ui.progress.running": "Running {n} · Done {ok} · Failed {fail}",
    "ui.progress.pending": "Pending {n}",
    "ui.progress.event": "Latest: {ev}",
    "versions.title": "Versions",
    "auth.passkeyLogin": "Sign in with Apple",
    ...
    "common.more": "More",
    "profile.field.accountEmail": "Account Email",
    "profile.field.loginSource": "Login Source",
    "profile.field.userId": "User ID",
    "profile.field.createdAt": "Joined At",
    "profile.field.lastSeen": "Last Login",
    "profile.field.displayName": "Display Name",
    "profile.field.avatarUrl": "Avatar URL",
    "profile.recent.title": "Recent Activity",
    "profile.recent.latestWork": "Latest Work",
    "profile.recent.latestIncome": "Latest Income",
    "profile.recent.latestPurchase": "Latest Purchase",
    "profile.recent.latestSale": "Latest Sale",
    "profile.recent.latestBounty": "Latest Bounty",
    "profile.recent.more.works": "Open Works Center for more",
    "profile.recent.more.income": "Open Billing panel for more",
    "profile.recent.more.purchases": "Open Watch panel for more",
    "profile.recent.more.sales": "Open Works Center for more",
    "profile.recent.more.bounty": "Open Billing panel for more",
    "profile.noData": "No data yet",
    "profile.ledgerRecord": "Ledger record",
    "profile.currentBalance": "Current balance",
    "profile.latestGenerated": "Latest generation: {time}",
    "profile.sourceLine": "Source: {source}",
    "profile.linkedLine": "Linked: {summary}",
    "profile.appleLine": "Apple: {email}",
    "auth.unknownSource": "Unknown source",
    "auth.sourceWithProvider": "{provider} login",
  ...
  zh: {
    ...
    "action.settings": "设置",
    "action.profile": "个人资料",
    "action.signin_apple": "使用 Apple 登录",
    "action.close": "关闭",
    "action.passkeyLogin": "Apple 登录",
    "action.passkeySettings": "Apple 登录设置",
    ...
    "login.passkey": "使用 Apple 登录",
    "billing.limitReached": "今日生成次数已达上限",
    "login.statusGuest": "游客",
    "login.statusSigned": "已登录",
    "login.logout": "退出登录",
    "passkey.title": "Apple 登录",
    "passkey.intro": "使用你的 Apple 账号安全登录。",
    "passkey.me.title": "当前登录状态",
    "passkey.me.btn": "刷新 /api/me",
    "passkey.bind.title": "绑定 Apple 登录（需要先登录）",
    "passkey.bind.device.placeholder": "设备名（可选，例如：我的 iPhone）",
    "passkey.bind.btn": "绑定 Apple 登录",
    "passkey.login.title": "使用 Apple 登录",
    "passkey.login.btn": "继续 Apple 登录",
    "passkey.list.title": "已绑定的 Apple 登录记录",
    "passkey.list.btn": "刷新列表",
    "passkey.delete.placeholder": "credential_id（从列表复制）",
    "passkey.delete.btn": "删除该 Apple 登录记录",
    "passkey.err.unsupported": "当前浏览器/环境不支持 Apple 登录。",
    "passkey.err.options_missing": "服务端没有返回 options",
    "passkey.err.create_failed": "配置 Apple 登录失败",
    "passkey.err.get_failed": "获取 Apple 登录信息失败",
    "profile.title": "个人资料",
    "profile.passkey": "Apple 登录",
    "profile.passkeyEnable": "启用",
    "profile.passkeyLogin": "使用 Apple 登录",
    "passkey.enabled": "已启用 Apple 登录",
    "passkey.not_enabled": "尚未启用 Apple 登录，请先启用。",
    "passkey.unsupported": "当前浏览器或设备不支持 Apple 登录",
    "passkey.register_options_failed": "获取启用信息失败，请稍后重试",
    "passkey.register_verify_failed": "启用 Apple 登录失败，请稍后重试",
    "passkey.login_options_failed": "获取登录信息失败，请稍后重试",
    "passkey.login_verify_failed": "验证失败，请重试或改用其他登录方式",
    "mic.submit_failed": "提交失败",
    "mic.listening": "正在聆听…松手提交",
    "mic.hold_to_create": "请长按话筒开始，松手即开始创作歌词。",
    "mic.submitting": "正在提交…",
    "mic.submitted": "已提交",
    "mic.permission_denied": "麦克风权限未开启",
    "mic.network_error": "网络不稳定",
    "mic.http_error": "请求失败",
    "ui.run_id": "任务",
    "status.pending": "等待中",
    "status.running": "运行中",
    ...
    "status.timeout": "已超时",
    "ui.progress.running": "运行中 {n} · 已完成 {ok} · 失败 {fail}",
    "ui.progress.pending": "等待中 {n}",
    "ui.progress.event": "最新事件：{ev}",
    "versions.title": "版本",
    "auth.passkeyLogin": "使用 Apple 登录",
    "versions.current": "当前",
    "works.subtitle": "作品中心",
    ...
    "common.more": "更多",
    "profile.field.accountEmail": "账号邮箱",
    "profile.field.loginSource": "登录来源",
    "profile.field.userId": "用户ID",
    "profile.field.createdAt": "加入时间",
    "profile.field.lastSeen": "最近登录",
    "profile.field.displayName": "显示名称",
    "profile.field.avatarUrl": "头像链接",
    "profile.recent.title": "最近动态",
    "profile.recent.latestWork": "最新作品",
    "profile.recent.latestIncome": "最新收入",
    "profile.recent.latestPurchase": "最新买的歌",
    "profile.recent.latestSale": "最新卖的歌",
    "profile.recent.latestBounty": "最新赏金",
    "profile.recent.more.works": "进入作品中心查看更多",
    "profile.recent.more.income": "进入账单面板查看更多",
    "profile.recent.more.purchases": "进入监听面板查看更多",
    "profile.recent.more.sales": "进入作品中心查看更多",
    "profile.recent.more.bounty": "进入账单面板查看更多",
    "profile.noData": "暂无数据",
    "profile.ledgerRecord": "账本记录",
    "profile.currentBalance": "当前余额",
    "profile.latestGenerated": "最近生成: {time}",
    "profile.sourceLine": "来源: {source}",
    "profile.linkedLine": "已绑定: {summary}",
    "profile.appleLine": "Apple: {email}",
    "auth.unknownSource": "未知来源",
    "auth.sourceWithProvider": "{provider} 登录",
    "provider.apple": "Apple",
    "provider.google": "Google",
    "provider.github": "GitHub",
    "provider.facebook": "Facebook",
