"use strict";
var fs = require('fs');
var getCompiledPath = require('/srv/cssos/node_modules/ts-node-dev/lib/get-compiled-path').getCompiledPath;
var sep = require('path').sep;
var join = require('path').join;
var extname = require('path').extname;
var execSync = require('child_process').execSync;
var Module = require('module');
var compilationId = '2964165357106503';
var timeThreshold = 0;
var allowJs = true;
var compiledDir = '/tmp/.ts-nodeL72SpV/compiled';
var preferTs = false;
var ignore = [/node_modules/];
var readyFile = '/tmp/ts-node-dev-ready-2964165357106503';
var execCheck = false;
var exitChild = false;
var sourceMapSupportPath = '/srv/cssos/node_modules/source-map-support/source-map-support.js';
var libPath = '/srv/cssos/node_modules/ts-node-dev/lib';
var checkFileScript = join("/srv/cssos/node_modules/ts-node-dev/lib", 'check-file-exists.js');
